...
cl /EHsc %1.obj %HB_PATH%\obj\vcw64\mainwin.obj /link /out:%1.exe /LIBPATH:..\lib /LIBPATH:%HB_LIB_DIR% %HWG_LIBS% %HB_LIBS% %SYS_LIBS% /NODEFAULTLIB:LIBC /NODEFAULTLIB:msvcrt /force:multiple /nxcompat:NO /subsystem:windows
