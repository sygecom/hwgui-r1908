rem Batch to compile tests using xHarbour and Clang 64-bit.
rem How to use:
rem xcompileclang64 filename <ENTER>
...
clang -o %1.exe %1.o %HB_PATH%\obj\clngw64\mainwin.o -L..\lib\win\clang64 -L%HB_LIB_DIR% -L%CLANG_PATH%\x86_64-w64-mingw32\lib -Wl,--start-group %HWG_LIBS% %HB_LIBS% %SYS_LIBS%  -Wl,--end-group -mwindows
