...
gcc -o %1.exe %1.o %HB_PATH%\obj\gc64\mainwin.o -L..\lib -L%HB_LIB_DIR% -L%MINGW_PATH%\x86_64-w64-mingw32\lib -Wl,--start-group %HWG_LIBS% %HB_LIBS% %SYS_LIBS%  -Wl,--end-group -mwindows
