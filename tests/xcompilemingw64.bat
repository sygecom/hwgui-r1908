rem Batch to compile tests using xHarbour and MinGW 64-bit.
rem How to use:
rem xcompilemingw64 filename <ENTER>
rem Require HB_PATH pointing to xHarbour dir and MINGW_PATH pointing to MinGW dir.
...
gcc -c -I..\include -I%HB_INC_DIR% %1.c

rem o -> exe

gcc -o %1.exe %1.o %HB_PATH%\obj\gc64\mainwin.o -L..\lib\win\mingw64 -L%HB_LIB_DIR% -L%MINGW_PATH%\x86_64-w64-mingw32\lib -Wl,--start-group %HWG_LIBS% %HB_LIBS% %SYS_LIBS%  -Wl,--end-group -mwindows
