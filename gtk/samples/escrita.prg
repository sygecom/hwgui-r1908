...
//createtoolbar(omodDlg:handle,0,0,20,20)   
   ...
   TOOLBUTTON  otool ;
           ...
           ON CLICK {|x,y|msginfo("ola"),hwg_Enablewindow(oTool:aItem[2,11],.t.) ,hwg_Enablewindow(oTool:aItem[1,11],.f.)}
   ...
   TOOLBUTTON  otool ;
          ID 702 ;
           ...
           TEXT "teste2"  ;
           TOOLTIP "ola2" ;
           ON CLICK {|x,y|msginfo("ola1"),hwg_Enablewindow(oTool:aItem[1,11],.t.),hwg_Enablewindow(oTool:aItem[2,11],.f.)}
