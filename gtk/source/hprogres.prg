...
METHOD HProgressBar:New(oWndParent, nId, nLeft, nTop, nWidth, nHeight, maxPos, nRange, bInit, bSize, bPaint, ctooltip)
...
METHOD HProgressBar:NewBox(cTitle, nLeft, nTop, nWidth, nHeight, maxPos, nRange, bExit)
